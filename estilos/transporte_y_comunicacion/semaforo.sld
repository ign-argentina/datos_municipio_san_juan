...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>semaforo</se:Name>
    <UserStyle>
      <se:Name>semaforo</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Semaforo 50.000.000 a 9.000.001</se:Name>
          <se:Description>
            <se:Title>Semaforo 50.000.000 a 9.000.001</se:Title>
          </se:Description>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:ExternalGraphic>
                <se:OnlineResource xlink:href="semaforo.svg" xlink:type="simple"/>
        ...
        <se:Rule>
          <se:Name>Semaforo 9.000.000 a 1.000.001</se:Name>
          <se:Description>
            <se:Title>Semaforo 9.000.000 a 1.000.001</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>Semaforo 1.000.000 a 0</se:Name>
          <se:Description>
            <se:Title>Semaforo 1.000.000 a 0</se:Title>
          </se:Description>
