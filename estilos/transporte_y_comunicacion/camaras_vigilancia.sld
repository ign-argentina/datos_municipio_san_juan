...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>camaras_vigilancia</se:Name>
    <UserStyle>
      <se:Name>camaras_vigilancia</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Camaras de vigilancia 50.000.000 a 9.000.001</se:Name>
          <se:Description>
            <se:Title>Camaras de vigilancia 50.000.000 a 9.000.001</se:Title>
          </se:Description>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:ExternalGraphic>
                <se:OnlineResource xlink:href="camaras_vigilancia.svg" xlink:type="simple"/>
        ...
        <se:Rule>
          <se:Name>Camaras de vigilancia 9.000.000 a 1.000.001</se:Name>
          <se:Description>
            <se:Title>Camaras de vigilancia 9.000.000 a 1.000.001</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>Camaras de vigilancia 1.000.000 a 0</se:Name>
          <se:Description>
            <se:Title>Camaras de vigilancia 1.000.000 a 0</se:Title>
          </se:Description>
